$(function() {
  ...
  var loadedPage = 1, postPerPage = 20;
  var numOfPost = $('.list_content').children().length;
  var pagesToLoad = 20;
  ...
  if ($(".infinite-spinner").length < 1 || numOfPost < postPerPage){
  ...
  function fetchPageWithIndex(index, callback) {
    ...
    var pageURL =  path + 'json/page' + index + '/index.html';
    $.get(pageURL)
    .done(function(res) {
